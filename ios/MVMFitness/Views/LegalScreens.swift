...
enum LegalPages {
    ...
    static let privacyPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "heart.text.square", title: "Apple Health", body: "If you choose to connect Apple Health, we'll read your steps and calories and save your workout sessions. That's it. Your health data never leaves the app, never gets sold, and never ends up in an ad. Pinky promise (the legally binding kind).", tint: Color(hex: "#EF4444")),
            LegalSection(icon: "apps.iphone", title: "What We Access & Why", body: "• Apple Health — steps, calories, workouts (you grant permission)\n• Pedometer — daily step count (stays on device)\n• Camera — QR scanning only (not selfies, we promise)\n• Calendar — sync workouts if you enable it\n• Photo Library — save share cards & score images\n• Notifications — your daily PT reminder\n\nEvery feature asks first. Nothing runs without your say-so.", tint: MVMTheme.warning),
