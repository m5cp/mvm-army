...
enum LegalPages {
    ...
    static let privacyPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "cart", title: "Third-Party Services", body: "If in-app purchases are available, subscription handling is managed through RevenueCat, which processes transactions via Apple's App Store infrastructure. RevenueCat does not receive your fitness data, health data, or any personally identifiable information from MVM Fitness. MVM Fitness uses TelemetryDeck, a privacy-first analytics service, to count anonymous feature usage (for example, how many times the calculator is used). No personal data, fitness values, scores, names, or health data are ever transmitted. No other third-party analytics, advertising, or tracking SDKs are included in this app.", tint: MVMTheme.accent2),
            ...
            LegalSection(icon: "envelope", title: "Contact", body: "For privacy-related questions or concerns, contact us through the App Store listing or via email.\n\nMVM Fitness is not affiliated with, endorsed by, or sponsored by the U.S. Department of War (formerly the Department of Defense), the Department of the Army, or any U.S. government agency.", tint: MVMTheme.accent2)
        ]
    )
    ...
    static let termsPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "heart.text.square", title: "Health Data", body: "If you grant Apple Health access, MVM Fitness reads your activity data for display within the app and writes completed Quick Start workout sessions back to Apple Health so they contribute to your activity rings and workout history. This data is never sold, shared, or transmitted externally. Your health data stays on your device at all times.", tint: MVMTheme.accent2),
            ...
            LegalSection(icon: "building.columns", title: "Independence Disclaimer", body: "MVM Fitness is not affiliated with, endorsed by, or sponsored by the U.S. Department of War (formerly the Department of Defense), the Department of the Army, or any U.S. government agency. All fitness standards referenced are based on publicly available information.", tint: MVMTheme.accent2),
