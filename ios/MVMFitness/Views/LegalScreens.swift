...
enum LegalPages {
    ...
    static let privacyPage = LegalPage(
        ...
        sections: [
            ...
            LegalSection(icon: "cart", title: "Third-Party Services", body: "If in-app purchases are available, subscription handling is managed through RevenueCat, which processes transactions via Apple's App Store infrastructure. RevenueCat does not receive your fitness data, health data, or any personally identifiable information from MVM Fitness. No third-party analytics, advertising, or tracking SDKs are included in this app.", tint: MVMTheme.accent2),
