                    ...
                    DragGesture(minimumDistance: 20)
                        ...
                        .onEnded { value in
                            ...
                            withAnimation(.spring(response: 0.35, dampingFraction: 0.86)) {
                                if value.translation.width < -threshold, let next = AppTab(rawValue: selectedTab.rawValue + 1) {
                                    selectedTab = next
                                } else if value.translation.width > threshold, let prev = AppTab(rawValue: selectedTab.rawValue - 1) {
                                    selectedTab = prev
                                }
                                dragOffset = 0
                            }
